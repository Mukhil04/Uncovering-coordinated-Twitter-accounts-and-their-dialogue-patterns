...
class Model(BaseModule):
    ...
    def forward(self, in_time, out_time, length, index, in_mark, out_mark, in_tweet_type, out_tweet_type, use_marks, device):
        input = Batch(in_time, out_time, length, index, in_mark, out_mark, in_tweet_type, out_tweet_type)
        if use_marks:
